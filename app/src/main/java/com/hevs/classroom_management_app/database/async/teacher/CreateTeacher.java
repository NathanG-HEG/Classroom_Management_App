...
public class CreateTeacher extends AsyncTask<Teacher, Void, Void> {
    private AppDatabase database;
    private OnAsyncEventListener callback;
    private Exception exception;

    public CreateTeacher(Context context, OnAsyncEventListener callback){
