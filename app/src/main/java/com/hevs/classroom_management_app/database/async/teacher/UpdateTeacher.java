...
public class UpdateTeacher extends AsyncTask<Teacher, Void, Void> {
    private AppDatabase database;
    private OnAsyncEventListener callback;
    private Exception exception;

    public UpdateTeacher(Context context, OnAsyncEventListener callback){
